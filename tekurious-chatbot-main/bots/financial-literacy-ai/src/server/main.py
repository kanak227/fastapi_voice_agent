...
log = logging.getLogger("financial-literacy-ai.chat")
...
register_playground(app, "Financial Literacy (standalone)")
...
async def chat(request: Request, accept: str | None = Header(default=None)):
    ...
    try:
        ...
        if not guardrails_output or guardrails_output.strip().upper() != "YES":
            refusal = "Sorry, I can only help with financial literacy topics."
        ...
        domain_label = "financial literacy"
