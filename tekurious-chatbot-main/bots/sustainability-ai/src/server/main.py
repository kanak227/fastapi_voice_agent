...
log = logging.getLogger("sustainability-ai.chat")
...
register_playground(app, "Sustainability (standalone)")
...
async def chat(request: Request, accept: str | None = Header(default=None)):
    ...
    try:
        ...
        if not guardrails_output or guardrails_output.strip().upper() != "YES":
            refusal = "Sorry, I can only help with sustainability and environmental topics."
        ...
        domain_label = "sustainability and environment"
