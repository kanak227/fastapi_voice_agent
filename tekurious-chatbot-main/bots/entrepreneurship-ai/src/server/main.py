...
log = logging.getLogger("entrepreneurship-ai.chat")
...
register_playground(app, "Entrepreneurship (standalone)")
...
async def chat(request: Request, accept: str | None = Header(default=None)):
    ...
    try:
        ...
        if not guardrails_output or guardrails_output.strip().upper() != "YES":
            refusal = "Sorry, I can only help with entrepreneurship and startup topics."
        ...
        domain_label = "entrepreneurship and startup"
