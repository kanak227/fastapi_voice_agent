...
log = logging.getLogger("emotional-intelligence-ai.chat")
...
register_playground(app, "Emotional Intelligence (standalone)")
...
async def chat(request: Request, accept: str | None = Header(default=None)):
    ...
    try:
        ...
        if not guardrails_output or guardrails_output.strip().upper() != "YES":
            refusal = "Sorry, I can only help with emotional intelligence topics."
        ...
        domain_label = "emotional intelligence"
