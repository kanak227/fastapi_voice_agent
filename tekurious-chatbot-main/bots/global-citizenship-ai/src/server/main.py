...
log = logging.getLogger("global-citizenship-ai.chat")
...
register_playground(app, "Global Citizenship (standalone)")
...
async def chat(request: Request, accept: str | None = Header(default=None)):
    ...
    try:
        ...
        if not guardrails_output or guardrails_output.strip().upper() != "YES":
            refusal = "Sorry, I can only help with global citizenship topics."
        ...
        domain_label = "global citizenship"
