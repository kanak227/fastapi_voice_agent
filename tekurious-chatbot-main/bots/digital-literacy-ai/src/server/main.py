...
log = logging.getLogger("digital-literacy-ai.chat")
...
register_playground(app, "Digital Literacy (standalone)")
...
async def chat(request: Request, accept: str | None = Header(default=None)):
    ...
    try:
        ...
        if not guardrails_output or guardrails_output.strip().upper() != "YES":
            refusal = "Sorry, I can only help with AI and digital literacy topics."
        ...
        domain_label = "AI and digital literacy"
